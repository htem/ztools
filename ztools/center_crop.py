...
def get_centered_roi(data_roi: Roi, size: Coordinate, voxel_size: Coordinate) -> Roi:
    ...
    centered_roi: Roi = Roi(data_center, (0,0,0)).grow(size / 2, size / 2).snap_to_grid(voxel_size, "grow")
    return centered_roi


if __name__ == "__main__":
    make_cutout(out_file="../tomo_vol.zarr", out_dataset="mouse_cb_full_inverted_crop", src_file="../tomo_vol.zarr", src_dataset="mouse_cb_full_inverted")