...
def save_volume_to_zarr(
    in_file_path: str = "/n/data3/hms/neurobio/htem/xnh/volraw/s46_V1_100nm_7_q3_rec_.raw",
    ...
    read_roi = write_roi = Roi(
        offset=(0,) * 3, shape=Coordinate((10, 10, 10))
    ...
    def zarr_write_worker(
        block: daisy.Block, im: np.ndarray = im, vol: np.ndarray = vol
    ) -> bool:
